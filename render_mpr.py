...
class RendererMPR():
    ...
    def set_camera(self, camera):
        ...
        :return:
        """
        render_common.logging.info("Set Camera:" + str(camera))
        ...
        # render_common.logging("Z-dir: " + z_dir_normalized)
        ...
        render_common.logging.info("Self._sliceAxis Begin:" + str(self._sliceAxis))
        self._sliceAxis.DeepCopy((x_dir_normal[0], camera_view_up[0], z_dir_normalized[0], camera_focal[0],
                                  ...
                                  0, 0, 0, 1))
        self._imageReslice.SetResliceAxes(self._sliceAxis)
        render_common.logging.info("Self._sliceAxis After:" + str(self._sliceAxis))
    ...
    def set_lut_property(self, property, label=0):
        ...
        self._lookupTable.SetNumberOfColors(2) # 256
        self._lookupTable.SetTableValue(0, 0, 0, 1)
        self._lookupTable.SetTableValue(1, 1, 1, 1)
        ...
        render_common.logging.info("SetLutProperty: " + str(self._lookupTable) )
    ...
    def render(self):
        ...
        :return:bool
        """
        render_common.logging.info("Render MPR Begin!")
        ...
        try:
            ...
            render_common.logging.error("Exception:" + str(e))

        render_common.logging.info("Render MPR End!")
    ...
    def get_output_png_image(self, filename):
        ...
        :return:
        """
        render_common.logging.info("Get Output PNG Result Begin!")
        try:
            self._pngWriter.SetFileName(filename)
            self._pngWriter.Write()
            self._pngWriter.Update()
            render_common.logging.info("pngWriter" + str(self._pngWriter))
        except BaseException as e:
            render_common.logging.error("Exception:" + str(e))
        render_common.logging.info("Get Output PNG Result End!")
